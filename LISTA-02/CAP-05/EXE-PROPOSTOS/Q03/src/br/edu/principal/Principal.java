...
public class Principal {
    public static void main(String[] args) {
        ...
        System.out.println("\nPorcentagem de pessoas na primeira faixa etária (até 15 anos): " + porcentagemFaixa1 + "%");
        System.out.println("Porcentagem de pessoas na última faixa etária (acima de 60 anos): " + porcentagemFaixa5 + "%");
